...
<html lang="en">
  <head>
    ...
    <title>
        ...
        Know More | GrivoTech | One Platform Solution | Department of Education, Govt. of Andhra Pradesh &middot; 
...
<div class="stage-shelf stage-shelf-right hidden" id="sidebar">
  <ul class="nav nav-bordered nav-stacked flex-column">
    ...
    <li class="nav-item">
      <a class="nav-link" href="knowmore.php">College List</a>
    </li>
    <li class="nav-item">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item px-1 dropdown">
          ...
          <div class="dropdown-menu">
          	...
          	<a class="dropdown-item" href="#">College List</a>
  ...
  <div class="container">
    <div class="row app-align-center">
      ...
      <div class="col-md-6 offset-md-1 col-sm-12 offset-sm-0">
        ...
        <p class="lead mb-4">GrivoTech is an initiative of Education Department, Govt. of Andhra Pradesh. This portal is trying to reduce the gap between students and teachers and to let teachers solve the students problem with all sorts of his own Safety and Comfort and maintain complete Privacy. <a href="#" class="text-primary">Read More</a> about Us.</p>
        <div class="row hidden-md-down">
          <div class="col-sm-6 mb-3">
            <h5>Associated Colleges</h5>
            <p>We are associated with almost all College providing Technical Degree courses to Students. <a href="#" class="text-primary">Know More</a> about colleges.</p>
          </div>
          <div class="col-sm-6">
            <h5>Features &amp; Facilities</h5>
            <p>We are tying to improve ourself to reduce the Panel team member's load and providing more safety and comfort here. <a href="#" class="text-primary">Learn more</a>.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-md-2 offset-md-1 mb-5">
        <ul class="list-unstyled list-spaced">
		  ...
		  <li><a href="#">Collegs & University</a></li>
