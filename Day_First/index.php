  ...
  <ul class="nav nav-bordered nav-stacked flex-column">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu">
        <a class="dropdown-item" href="user/userlogin.php">Student</a>
        <a class="dropdown-item" href="faculty/cllglogin.php">College</a>
      </div>
    </li>
    <li class="nav-item dropdown">
    ...
    <div class="hidden-sm-down text-uppercase">
      <ul class="navbar-nav">
        ...
        <li class="nav-item px-1 dropdown">
          ...
          <div class="dropdown-menu">
            <a class="dropdown-item" href="user/userregistration.php">Student</a>
          </div>
        </li>
        <li class="nav-item px-1 dropdown">
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-10 col-lg-6">
          <h1 class="block-titleData frequency">Redefining Solutions Digitally</h1>
