...
<head>
	...
	<title>Transport | Solved Grievance | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 ...
			 <li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li class="active">Transport | Solved Grievance</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Transport : Solved Grievance</h3>
						</div>
