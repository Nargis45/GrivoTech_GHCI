...
<head>
	...
	<title>Edit College Details | Admin | GrivoTech</title>
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($db,"select * from academy where id='$id'");
...
<div class="controls">
<input type="text" placeholder="Enter college Name"  name="college" value="<?php echo  htmlentities($row['collegeName']);?>" class="span8 tip" required>
</div>
</div>
