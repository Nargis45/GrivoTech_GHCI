...
<head>
	...
	<title>Unsolved Grievance | Anonymous | GrivoTech</title>
		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li><a href="solvedGrievanceSection.php" style="text-decoration: none;">Un-Solved Grievance Menu</a></li>
			 	<li class="active">Un-Solved | Anonymous Grievance Overview</li>
			</ol>
		</div>
	</section>
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Un-Solved | Anonymous Grievance Overview</h3>
						</div>
...
<tbody>
<?php 
$query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status is null and complain.isAnonymous='1' ");
