		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li><a href="solvedGrievanceSection.php" style="text-decoration: none;">Solved Grievance Menu</a></li>
			 	<li class="active">Solved | Anonymous Grievance Overview</li>
			</ol>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-2">
					<div class="list-group">
						...
						<a href="solvedGrievanceSection.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> Solved Grievance <span class="badge"></span></a>
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Solved | Anonymous Grievance Overview</h3>
						</div>
...
<?php 
$status="closed";
$query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status='$status' and complain.isAnonymous='1' ");
