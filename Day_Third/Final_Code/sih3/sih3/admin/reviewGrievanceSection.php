...
<head>
	...
	<title>In-Progress Grievance | GrivoTech</title>
	<!-- Bootstrap core CSS -->
		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li class="active">In-Progress Grievance</li>
			</ol>
		</div>
	</section>
			...
			<div class="row">
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						...
						<h3 class="panel-title">Grievance Menu : In-Progress</h3>
						</div>
						<div class="panel-body" style="min-height: 400px;">

							<a href="AdminreviewGrievance.php"><div class="col-md-4 col-md-offset-2">
...
<?php } ?>
							...
							<a href="AdminreviewGrievanceAnonymous.php"><div class="col-md-4">
								<div class="well dash-box">
