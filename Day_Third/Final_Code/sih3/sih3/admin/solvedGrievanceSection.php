...
<head>
	...
	<title>Solved Grievance | GrivoTech</title>
	<!-- Bootstrap core CSS -->
		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li class="active">Solved Grievance</li>
			</ol>
		</div>
	</section>
...
<a href="petitions.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> View Petitions <span class="badge"></span></a>
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						...
						<h3 class="panel-title">Grievance Menu : Solved</h3>
						</div>
						<div class="panel-body" style="min-height: 400px;">
							<a href="AdminsolvedGrievance.php"><div class="col-md-4 col-md-offset-2">
...
<?php } ?>
							...
							<a href="AdminsolvedGrievanceAnonymoususer.php"><div class="col-md-4">
								<div class="well dash-box">
