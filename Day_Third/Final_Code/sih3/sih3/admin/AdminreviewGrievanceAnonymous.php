		...
		<div class="container" style="margin-top: 2% ; width: 97%;">
			<ol class="breadcrumb">
				<li><input type="button" value="Back" onclick="history.go(-1)"></li>
			 	...
			 	<li class="active">In-Progress | Normal Grievance Overview</li>
			</ol>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-2">
					<div class="list-group">
						...
						<a href="reviewGrievanceSection.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> In-Progress Grievance <span class="badge"></span></a>
				...
				<div class="col-md-10">
					...
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">In-Progress | Normal Grievance Overview</h3>
						</div>
...
$status="in process";
$isAnonymous="1";
$query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status='$status' and complain.isAnonymous='$isAnonymous'");
