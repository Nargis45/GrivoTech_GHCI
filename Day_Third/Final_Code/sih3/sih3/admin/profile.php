...
<head>
	...
	<title>Admin Profile | GrivoTech</title>
	<!-- Bootstrap core CSS -->
...
<div class="col-sm-4">
<input type="text"  name="university" required="required" class="form-control" readonly value="university Name">
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">UniversityId</label>
 <div class="col-sm-4">
<input type="text" name="registration" required="required" value="University ID" class="form-control" required readonly>
</div>
</div>
