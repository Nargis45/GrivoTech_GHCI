...
<tbody>
<?php 
$query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status is null ");
