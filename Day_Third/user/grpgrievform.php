		...
		<section id="breadcrumb">
			<div class="container" style="margin-top: 2%;">
				<ol class="breadcrumb">
					...
					<li class="active">Register Group Greivance</li>
				</ol>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="list-group">
							...
							<a href="grpgrievform.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Register Group Grievance</a>
											...
											<div class="modal-dialog modal-lg">
												<div class="modal-content">
													...
													<div class="modal-body">
														<p>Write terms of Group grievance here........ </p>
													</div>
					...
					<?php
						...
						echo "
							<div class='col-md-9'>
								<div class='panel panel-default'>
									<div class='panel-heading main-color-bg'>
										Group complaint registered successfully.
									</div>
									<div class='panel-body'>
										You can view and share your group complaint at: <a href=" . $url . ">" . $url . "</a>
									</div>
								</div>
							</div>
						 ";
