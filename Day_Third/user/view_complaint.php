            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="list-group">
                        ...
                        <a href="grpgrievview.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> View Group Grievances</a>
