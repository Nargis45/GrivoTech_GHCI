...
<head>
	...
	<title>View Group Grievances | GrivoTech</title>
	<!-- JQUERY -->
		...
		<section id="breadcrumb">
			<div class="container" style="margin-top: 2%;">
				<ol class="breadcrumb">
					...
					<li class="active">View Group Grievances</li>
				</ol>
			</div>
		</section>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="list-group">
							...
							<a href="grpgrievform.php" class="list-group-item"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Register Group Grievance</a>
							<a href="grpgrievview.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> View Group Grievances</a>
					...
					<div class="col-md-9">
						<div class="panel panel-default">
							<div class="panel-heading main-color-bg">
								<h3 class="panel-title">View Group Grievances Details</h3>
							</div>
														...
														<form method="post">
															...
															<table class="table table-bordered table-striped table-condensed table-responsive">
																...
																<tbody>
																	...
																	?>
																		<tr>
																			<td align="center"><?php echo $r['categoryName']; ?></td>
																			<!-- Show only first 100 characters of the complaint -->
																			<td align="center"><?php echo substr($r['complain'], 0, 100); ?></td>
																			<td align="center"><?php echo $r['regDate']; ?></td>
																			<td align="center">
																				<?php
																				echo $r["status"];
