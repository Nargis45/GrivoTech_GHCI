                      ...
                      <?php }?>
						...
						<div class="panel-body" style="min-height: 400px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                	<textarea class="txtarea col-md-12" name="complain" required rows="6" value="<?php if(isset($_POST['complain'])){echo $_POST['complain'];} ?>"></textarea>
                                </div>
                            </div>
                            ...
                            <br>
                             <div class="col-md-4 control-label">
                                	<input type="checkbox" name="anonymoususer" value="1"
                                	id="anonymoususer">File Complain Anonymously 
                                </input>
                               </div><br> <br>
