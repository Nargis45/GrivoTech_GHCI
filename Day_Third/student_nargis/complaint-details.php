...
<!--navigation bar-->
			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="viewgrievance.php" class="list-group-item  active main-color-bg"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> View Filed Grievance</a>
 ...
 <?php $query=mysqli_query($db,"select complain.*,category.categoryName as catname from complain join category on category.id=complain.grievanceId where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");
...
<label class="col-sm-2 col-sm-2 control-label"><b>Remark:</label>
              <div class="col-sm-10">
   <p style="font-weight: normal;"><?php echo  htmlentities($rw['remark']); ?><p>
   </div>
   </div>
   <div class="row mt">
            
   <label class="col-sm-2 col-sm-2 control-label"><b>Remark Date: </label>
    <div class="col-sm-10">
   <p style="font-weight: normal;"><?php echo  htmlentities($rw['rdate']); ?></p>
              </div>
            </div> 
 <div class="row mt">
