...
<head>
	...
	<title>Dashboard | GrivoTech | One Platform Solution | Department of Education, Govt. of Andhra Pradesh</title>
	<!-- Bootstrap Core CSS -->
...
$rt = mysqli_query($db,"SELECT c.complaintNumber,c.complain,a.collegeName FROM complain c join student s on c.userId=s.student_id join academy a on s.college=a.id where c.status is null");
