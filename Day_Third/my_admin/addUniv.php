...
$sql=mysqli_query($db,"insert into university(univName,email,password) values('$univ','$email','$password')");
...
if(isset($_GET['del']))
		  {
		          mysqli_query($db,"delete from university where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="University deleted !!";
		  }
			...
			<div class="row">
				<div class="col-md-3">
					<div class="list-group">
						...
						<a href="viewgrievances.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> View Grievances <span class="badge"></span></a>
...
<a href="petitions.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> View Petitions <span class="badge"></span></a>
						<a href="addUniv.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Add University</a>
...
<div class="controls">
<input type="text" placeholder="Enter University Name"  name="univ" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<?php $query=mysqli_query($db,"select * from university");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>									
										<tr>
											<td><?php echo htmlentities($row['univName']);?></td>
											<td><?php echo htmlentities($row['email']);?></td>
											<td><?php echo htmlentities($row['password']);?></td>
											<td> <?php echo htmlentities($row['postingDate']);?></td>
											<td><?php echo htmlentities($row['updationDate']);?></td>
											<td>
											<a href="edit-univ.php?id=<?php echo $row['id']?>" ><i class="icon-edit"></i></a>
