...
$ret=mysqli_query($db,"SELECT * FROM admin WHERE email='$email' and password='$password'");
...
<head>
	...
	<title>Login | Admin | GrivoTech</title>
	...
	<article class="login-page">
		<section class="form">
			<form class="student-form" method="post">
				...
				<fieldset>
					<legend>Admin | Login | GrivoTech</legend><br>
					<span style="color:red;" ><?php echo htmlentities($_SESSION['errmsg']); ?><?php echo htmlentities($_SESSION['errmsg']="");?></span>
					<label for="email">Email-Id <i class="fa fa-envelope" aria-hidden="true"></i><br><input type="email" name="email" id="email_id" placeholder="Enter your registered Email-Id" value="admin@grivo.com" required></label><br>
					<label for="password-registration-admin">Password <i class="fa fa-key" aria-hidden="true"></i><br><input type="password" name="password" id="txtpassword" value="12345" placeholder="Enter your Password here" required></label><br><br>
