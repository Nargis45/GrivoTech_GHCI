				...
				<div class="row">
					<div class="col-md-3">
						<div class="list-group">
							...
							<a href="pushF.php" class="list-group-item"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span> View allocated Grievances <span class="badge"></span></a>
					...
					<div class="col-md-9">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" style="min-height: 400px;">
									...
									<div class="col-md-4 col-md-offset-2">
										<div class="well dash-box">
											<h2><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>
												<?php
												$rt = mysqli_query($db, "SELECT * FROM complain where status is ".$_GET['status']);
								...
								<a href="unsolvedGrievanceAnonymousUser.php">
									<div class="col-md-4">
										<div class="well dash-box">
