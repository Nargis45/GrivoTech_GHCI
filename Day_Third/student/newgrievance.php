...
if (strlen($_SESSION['login']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($db, "insert into complain(userId,grievanceId,complain,proof,isAnonymous, isGroupComplaint) values('$uid','$grievance','$complain','$name','$isAnonymous', 0)");
		...
		<section id="breadcrumb">
			<div class="container" style="margin-top: 2% ; width: 97%;">
				<ol class="breadcrumb">
					...
					<li class="active">Register Grievance</li>
				</ol>
			</div>
		</section>
							...
							<form method="post" enctype="multipart/form-data">
								<div class="panel-body" style="min-height: 400px;">
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<textarea class="txtarea col-md-12" name="complain" required rows="6" value="<?php if (isset($_POST['complain'])) {
																																echo $_POST['complain'];
																															} ?>"></textarea>
										</div>
									</div>
									...
									<div class="col-md-4 control-label">
										<input type="checkbox" name="anonymoususer" value="1" id="anonymoususer"> &nbsp;&nbsp; <strong> File Complain Anonymously </strong>
										</input>
									</div><br> <br>
									<!-- <div class="form-group colmd-4 col-md-offset-4">
                            
								   <input type="checkbox" data-toggle="modal" data-target="#Conditions">  File complaint anonymously</input>
								</div>
		    <div class="form-group">
