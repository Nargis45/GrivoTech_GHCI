...
<head>
	...
	<title>Add College | GrivoTech</title>
			...
			<div class="col-md-9">
				<div class=" panel panel-default">
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head panel-heading main-color-bg">
...
<div class=" panel panel-default">
	...
	<div class="module">
							<div class="module-head panel-heading main-color-bg">
								<h3 class="panel-title">Manage Colleges</h3>
							</div>
							<div class="panel-body">
...
?>									
										<tr>
											...
											<a href="addCollege.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
										</tbody>
								</table>
