...
<head>
	...
	<title>Fees | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 <ol class="breadcrumb">
			 	...
			 	<li class="active">Fees | Overview</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Fees Overview</h3>
						</div>
...
$rt = mysqli_query($db,"SELECT * FROM complain where status is null and grievanceId=10");
					  ...
					  <a href="fees2.php">
							<div class="col-md-4">
								...
								<div class="well dash-box" style="height:150px;">
									<h2><center><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <?php
  $status="in process";
$rt = mysqli_query($db,"SELECT * FROM complain where status='$status' and grievanceId=10");
$num1 = mysqli_num_rows($rt);
{?>
					  			<h3><?php echo htmlentities($num1);?></h3></center></h2>
