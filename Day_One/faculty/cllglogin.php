		...
		<section class="form">
			<form class="college-login-form" method="post">
				...
				<fieldset>
					...
					<label for="email">College Email Id <i class="fa fa-envelope" aria-hidden="true"></i><br><input type="text" name="email" id="fullname-user" placeholder="Enter UserName"></label><br>
