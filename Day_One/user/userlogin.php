		...
		<section class="form">
			...
			<form class="student-form" method="post">
				...
				<fieldset>
					...
					<label for="username">User Id <i class="fa fa-user-circle" aria-hidden="true"></i><br><input type="text" name="email" id="fullname-user" placeholder="Enter Email Id" required autofocus></label><br>
					
					<label for="password-registration-user">Password <i class="fa fa-key" aria-hidden="true"></i><br><input type="password" name="password" id="txtPassword" placeholder="Enter your Password here"></label><br>
					...
					<hr>
					<p class="message">First time User? <a href="userregistration.php"> Register <i class="fa fa-sign-in" aria-hidden="true"></i></a></p>
				</fieldset>
                  </form>
