...
<head>
	...
	<title>Caste Issue | In-Process Grievance | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 <ol class="breadcrumb">
			 	...
			 	<li class="active">Caste Issue | In-Process Grievance</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Caste Issue : In-Process Grievance</h3>
						</div>
						...
						<div class="panel-body" style="min-height: 400px;">
							 ...
							 <!-- Start 2nd Column -->
                              ...
                              <?php
							  $status="in Process";
                              $query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status ='$status' and complain.grievanceId='6' ORDER BY regDate DESC");
