...
<head>
	...
	<title>Fees | In-Process Grievance | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 <ol class="breadcrumb">
			 	...
			 	<li><a href="feesGrievance.php" style="text-decoration: none;">Fees Overview</a></li>
			 	<li class="active">Fees | In-Process Grievance</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Fees : In-Process Grievance</h3>
						</div>
						...
						<div class="panel-body" style="min-height: 400px;">
							 ...
							 <!-- Start 2nd Column -->
							  ...
							  <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	table-responisve display" >
									<thead>
										<tr>
											<th>Complaint No</th>
                              ...
                              <?php
							  $status="in Process";
                              $query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status ='$status' and complain.grievanceId='10' ORDER BY regDate DESC");
