...
<head>
	...
	<title>Cleanliness | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 <ol class="breadcrumb">
			 	...
			 	<li class="active">Cleanliness | Overview</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Cleanliness Overview</h3>
						</div>
						<div class="panel-body" style="min-height:400px;">
						<a href="cleanliness1.php">
							<div class="col-md-4">
								<div class="well dash-box" style="height:150px;">
									<h2><center><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <?php

$rt = mysqli_query($db,"SELECT * FROM complain where status is null and grievanceId=9");
...
{?>
                      ...
                      <?php }?>
					  <a href="cleanliness2.php">
							<div class="col-md-4">

								<div class="well dash-box" style="height:150px;">
									<h2><center><span class="glyphicon glyphicon-list" aria-hidden="true"></span> <?php
  $status="in process";
$rt = mysqli_query($db,"SELECT * FROM complain where status='$status' and grievanceId=9");
$num1 = mysqli_num_rows($rt);
{?>
					  			<?php echo htmlentities($num1);?></center></h2>
