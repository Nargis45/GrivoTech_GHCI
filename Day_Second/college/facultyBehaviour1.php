...
<head>
	...
	<title>Faculty Behaviour | Un-Solved Grievance | Grievance Menu | GrivoTech</title>
	<!-- Bootstrap Core CSS -->
	...
	<section id="breadcrumb">
		<div class="container" style="margin-top: 2%;">
			 <ol class="breadcrumb">
			 	...
			 	<li><a href="facultyBehaviourGrievance.php" style="text-decoration: none;">Faculty Behaviour Overview</a></li>
			 	<li class="active">Faculty Behaviour | Un-Solved Grievance</li>
			 </ol>
		</div>
	</section>
				...
				<div class="col-md-9">
					<div class="panel panel-default">
						<div class="panel-heading main-color-bg">
							<h3 class="panel-title">Faculty Behaviour : Un-Solved Grievance</h3>
						</div>
							 ...
							 <!-- Start 2nd Column -->
							  ...
							  <div class="col-sm-9 col-md-12 mt-5">
								  ...
								  <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	table-responsive display" >
                                    ...
                                    <tbody>
                              <?php
                              $query=mysqli_query($db,"select complain.*,student.name as name from complain join student on student.student_id=complain.userId where complain.status is null and complain.grievanceId='3' ORDER BY regDate DESC");
